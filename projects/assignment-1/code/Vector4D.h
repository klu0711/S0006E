...
{
	return Vector4D(vector[0] + rhs.vector[0], vector[1] + rhs.vector[1], vector[2] + rhs.vector[2], vector[3]);
}
/// Operator overload for standard vector subtraction
Vector4D Vector4D::operator-(const Vector4D& rhs) const
{
	return Vector4D(vector[0] - rhs.vector[0], vector[1] - rhs.vector[1], vector[3] - rhs.vector[2], vector[3]);
}
/// Operator overload for the product of a vector and a scalar
Vector4D Vector4D::operator*(const float& rhs) const
{
	return Vector4D(vector[0] *rhs, vector[1] *rhs, vector[2] *rhs, vector[3]);
}
/// Getter
...
Vector4D Vector4D::normalize() const
{
	...
	return Vector4D(vector[0] / length, vector[1] / length, vector[2] / length, vector[3]);
}
...
{
	return Vector4D((vector[1]*vec.vector[1]) - (vector[2]*vec.vector[1]), (vector[2]*vec.vector[0]) - (vector[0]*vec.vector[1]), (vector[0]*vec.vector[1]) - (vector[1]*vec.vector[0]), vector[3]);
}
